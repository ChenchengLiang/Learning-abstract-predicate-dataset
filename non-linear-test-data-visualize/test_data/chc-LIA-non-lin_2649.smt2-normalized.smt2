...
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 Int) (var4 Int)) (or (not (and (and (f_s1 var4) (f_sf var3 var2)) (and (and (and (= (+ var3 (* (- 1) var1)) 11) (= var4 var1)) (= var2 var0)) (<= 0 (+ 100 (* (- 1) var1)))))) (f_s3 var1 var0))))
(assert (forall ((var0 Int) (var1 Int)) (or (not (and (f_s1_2_1 var1) (and (= (+ var1 (* (- 1) var0)) (- 11)) (<= 0 (+ 111 (* (- 1) var0)))))) (f_s1 var0))))
...
(assert (forall ((var0 Int)) (or (not (<= 0 (+ 100 (* (- 1) var0)))) (f_s1 var0))))
